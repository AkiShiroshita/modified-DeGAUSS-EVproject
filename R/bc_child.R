...
# during childhood. Black carbon is a component of fine particulate
...
d_bc_summary <- d[, rbindlist(bc), by = recip][, .(average_bc_childhood = mean(value, na.rm = TRUE)), by = recip]
