# ============================================================================
# Black Carbon (BC) Exposure Assessment - Pregnancy/Dyad Cohort
# ============================================================================
# This script assigns black carbon exposure estimates for the dyad cohort
# during pregnancy period. Black carbon is a component of fine particulate
...
d_bc_summary <- d[, rbindlist(bc), by = recip][, .(average_bc_pregnancy = mean(value, na.rm = TRUE)), by = recip]
