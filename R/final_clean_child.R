...
files <- paste0(temp_folder, "/temp_degauss_child", 21:26, "/temp_geocoded_census_road_greenspace_dep_aadt_road_density.rds")
...
combined_data_selected |> readr::write_csv("X:/data/modified_degauss/env_data_long_child.csv")
...
temp_folder <-   "Z:/Data/Tan/temp"
files <- paste0(temp_folder, "/temp_degauss_child", 21:26, "/d_no2_summary.rds")
...
# Change the directory as needed
combined_data |> readr::write_csv("X:/data/modified_degauss/no2_summary_child.csv")
...
temp_folder <-   "Z:/Data/Tan/temp"
files <- paste0(temp_folder, "/temp_degauss_child", 21:26, "/d_bc_summary.rds")
...
# Change the directory as needed
combined_data |> readr::write_csv("X:/data/modified_degauss/bc_summary_child.csv")
...
temp_folder <-   "Z:/Data/Tan/temp"
files <- paste0(temp_folder, "/temp_degauss_child", 21:26, "/d_bc_biomass_summary.rds")
...
# Save final BC summary data (one row per child: average BC exposure)
# Change the directory as needed
combined_data |> readr::write_csv("X:/data/modified_degauss/bc_biomass_summary_child.csv")
...
temp_folder <-   "Z:/Data/Tan/temp"
files <- paste0(temp_folder, "/temp_degauss_child", 21:26, "/temp_geocoded_deprivation_britt.fst")
