# ============================================================================
# Biomass-specific Black Carbon (BC) Exposure Assessment - Child Cohort
# ============================================================================
# This script assigns biomass-specific black carbon exposure estimates for the child cohort
# ============================================================================
...
d <- d[state == "TN" & start_date >= as.Date("2000-01-01") & end_date <= as.Date("2013-12-31")]
...
d_bc_summary <- d[, rbindlist(bc), by = recip][, .(average_bc_biomass_childhood = mean(value, na.rm = TRUE)), by = recip]
