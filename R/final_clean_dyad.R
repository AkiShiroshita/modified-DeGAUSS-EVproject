...
combined_data_selected |> readr::write_csv("X:/data/modified_degauss/env_data_long_dyad.csv")
...
# Change the directory as needed
combined_data |> readr::write_csv("X:/data/modified_degauss/no2_summary_dyad.csv")
...
# Change the directory as needed
#combined_data |> readr::write_csv("X:/data/modified_degauss/bc_summary_infancy.csv")
combined_data |> readr::write_csv("X:/data/modified_degauss/bc_summary_dyad.csv")
...
temp_folder <-   "Z:/Data/Tan/temp"
files <- paste0(temp_folder, "/temp_degauss_dyad", 1:5, "/d_bc_biomass_summary.rds")
...
# Change the directory as needed
#combined_data |> readr::write_csv("X:/data/modified_degauss/bc_summary_infancy.csv")
combined_data |> readr::write_csv("X:/data/modified_degauss/bc_biomass_summary_dyad.csv")
...
combined_data_britt %>% write_csv("X:/data/Britt_preliminary_data/preliminary_analysis_data/deprivation_index_long_dyad.csv")
combined_data_britt %>% write_csv("X:/data/modified_degauss/deprivation_index_long_dyad.csv")
